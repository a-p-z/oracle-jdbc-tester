...
```sh
java -jar target/oracle-jdbc-tester-1.1-jar-with-dependencies.jar --user $DB_USER" --password "$DB_PASS" --url dbc:oracle:thin:@//<host>:<port>/<service-name> --stop-after-delay 15
```
