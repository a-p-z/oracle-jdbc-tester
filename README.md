...
```sh
java -jar target/oracle-jdbc-tester-1.1-jar-with-dependencies.jar <schema_name> <schema_password> jdbc:oracle:thin:@//<host>:<port>/<SID>
```
...
```sh
java -jar target/oracle-jdbc-tester-1.1-jar-with-dependencies.jar "$DB_USER" "$DB_PASS" jdbc:oracle:thin:@//<host>:<port>/<SID>
```
